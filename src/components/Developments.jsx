  ...
  const projects = [
    {
      ...
      status: 'ONGOING',
      desc: 'Stunning luxury villas designed with modern steel architecture, private pools, and sustainable systems in Jubilee Hills.',
    ...
    },
    {
      ...
      category: 'COMMERCIAL',
      status: 'ONGOING',
      desc: 'State-of-the-art office spaces offering high-traffic accessibility, triple-height lobbies, and smart energy grid integration in Hitec City.',
      img: commercialImage,
    ...
    },
    {
      ...
      category: 'PLOTTING',
      status: 'COMPLETED',
      desc: 'Fully developed premium villa plots with custom blacktop roads, underground cabling, and landscaped boundary pathways in Moinabad.',
      img: plottingImage,
    ...
    },
    {
      ...
      category: 'RESIDENTIAL',
      status: 'UPCOMING',
      desc: 'Premium sky apartments in Gachibowli showcasing wide glass balconies, infinity viewing decks, and integrated smart home automation.',
      img: residentialImage,
    ...
    },
    {
      ...
      category: 'COMMERCIAL',
      status: 'COMPLETED',
      desc: 'A modern, high-occupancy business park center defined by structural glass columns, elevator cores, and custom light wells in Kallakal.',
      img: commercialImage,
    ...
    },
    {
      ...
      category: 'PLOTTING',
      status: 'ONGOING',
      desc: 'High-appreciating plots ready for construction, nestled in a fast-developing suburban zone with modern amenities and gated security in Shadnagar.',
      img: plottingImage,
    ...
    },
    {
      ...
      category: 'RESIDENTIAL',
      status: 'COMPLETED',
      desc: 'Completed luxury residential units in Kondapur showcasing raw board-formed concrete and premium frameless sliding window layouts.',
      img: residentialImage,
    ...
    },
    {
      ...
      category: 'COMMERCIAL',
      status: 'UPCOMING',
      desc: 'Upcoming landmark business plaza in Kokapet designed with self-cleaning glazed structures and a dramatic central glass dome.',
      img: commercialImage,
    ...
    },
    {
      ...
      category: 'PLOTTING',
      status: 'UPCOMING',
      desc: 'Pre-launch residential plotting layout featuring green parks, wide water storage systems, and tree-lined walkways in Adibatla.',
      img: plottingImage,
