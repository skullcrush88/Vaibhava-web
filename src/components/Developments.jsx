...
export default function Developments() {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: 'COMMERCIAL',
      status: 'ONGOING',
      desc: 'State-of-the-art office spaces offering high-traffic accessibility, triple-height lobbies, and smart energy grid integration in Hyderabad.',
      img: commercialImage,
    ...
    },
    {
      ...
      category: 'PLOTTING',
      status: 'COMPLETED',
      desc: 'Fully developed premium villa plots with custom blacktop roads, underground cabling, and landscaped boundary pathways in Hyderabad.',
      img: plottingImage,
    ...
    },
    {
      ...
      category: 'RESIDENTIAL',
      status: 'UPCOMING',
      desc: 'Premium sky apartments in Hyderabad showcasing wide glass balconies, infinity viewing decks, and integrated smart home automation.',
      img: residentialImage,
